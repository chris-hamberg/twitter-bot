CREATE TABLE IF NOT EXISTS state (
    ...
    /* The following commented lines are for DM support, but
    DM is not provided by API v2 so the feature is not implemented*/
    --direct_message_delta    DATETIME DEFAULT CURRENT_TIMESTAMP,
    --direct_message_count    INTEGER DEFAULT 0,
    --profile_crawler_delta   DATETIME DEFAULT CURRENT_TIMESTAMP,
    --tweet_crawler_index     INTEGER DEFAULT 0,
    --tweet_crawler_delta     DATETIME DEFAULT CURRENT_TIMESTAMP,
